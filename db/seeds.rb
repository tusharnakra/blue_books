...
Member.create!(email_address: "fileshare597@gmail.com", first_name: "file", last_name: "share" , pennkey: "file", school_id: school_2.id, group_id: email_group_0.id, email: 'fileshare597@gmail.com', password: '12345678', password_confirmation: '12345678')

Book.create(name: "Moore", attachment: File.open(File.join(Rails.root,"public/app/assets/Moore.pdf")))
Book.create(name: "Levine", attachment: File.open(File.join(Rails.root,"public/app/assets/Levine.pdf")))
Book.create(name: "Van Pelt",  attachment: File.open(File.join(Rails.root,"public/app/assets/Van Pelt.pdf")))
